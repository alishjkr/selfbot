        ...
        if op.type == 25:
            ...
            if msg.text in ["My id"]:
              ...
              if msg.toType == 2:
                ...
                dz.sendMessage(msg.to,"Sijones ini ɴᴏʜ ʏɢ ʙɪᴋɪɴ ɢʀᴜᴘ ɪɴɪ..")
...
#=================================================                
                            ...
                            try:
                                ...
                                dz.sendMessage(msg.to, "Sabar mas lagi di puterin...😍")
...
#=============================================
                ...
                if wait["atebz"] == True: md+="╠➣ᴀᴅᴅ ᴛᴇʙᴢ : ✔\n"
                else:md+="╠➣ ᴀᴅᴅ ᴛᴇʙᴢ : ❌\n"
                if wait["dtebz"] == True: md+="╠➣ᴅᴇʟ ᴛᴇʙᴢ : ✔\n"
                else:md+="╠➣ᴅᴇʟ ᴛᴇʙᴢ : ❌\n"
